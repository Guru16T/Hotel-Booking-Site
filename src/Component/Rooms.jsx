                        ...
                        <div className="col-md-6">
                            <div className="rooms-hero-inner mt-5 pt-5">
                                ...
                                <p className="rooms-subtitle">
                                    Each room is unique, shaped by its history and<br />
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-5 mb-4 mb-lg-0">
                                <img src={bed} class="img-fluid w-100 rounded-0" alt="Double room" />
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-4">
                                <h2 class="display-5 room-title mb-2">Double room</h2>

                                <p class="small fw-bold mb-4">
                                    10–14 m²&nbsp; | &nbsp;Standard&nbsp; | &nbsp;Max 2&nbsp; | &nbsp;From NOK 1,400
                                </p>

                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        <p class="mb-2 small">Twin or double bed</p>
                                        <p class="mb-2 small">Bathroom with a shower</p>
                                        <p class="mb-2 small">Homemade breakfast included</p>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="mb-2 small">TV</p>
                                        <p class="mb-2 small">Hairdryer</p>
                                        <p class="mb-2 small">Wifi available</p>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 mb-4 mb-lg-0">
                                <img src={bed3}
                                    ...
                                    alt="Historic double room" />
                            </div>
                            <div className="col-md-1"></div>

                            <div class="col-md-4">
                                <h2 class="display-5 room-title mb-2">Historic Double room</h2>

                                <p class="small fw-bold mb-4">
                                    19 m²&nbsp; | &nbsp;Max 2&nbsp; | &nbsp;From NOK 1,650
                                </p>
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        <p class="mb-2 small">Twin or double bed</p>
                                        <p class="mb-2 small">Bathroom with a shower</p>
                                        <p class="mb-2 small">Private bathroom</p>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="mb-2 small">TV</p>
                                        <p class="mb-2 small">Hairdryer</p>
                ...
                <div class="py-5 bg-light-pink">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <h2 class="display-5 room-title mb-2">Singel room</h2>

                                <p class="small fw-bold mb-4">
                                   10 m²&nbsp; | &nbsp;Standard&nbsp; | &nbsp;Max 1&nbsp; | &nbsp;From NOK 1,400
                                </p>

                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        <p class="mb-2 small">Single bed</p>
                                        <p class="mb-2 small">TV</p>
                                        <p class="mb-2 small">Bathroom with a shower</p>
                                    </div>
                                    <div class="col-sm-6">
                ...
                <div class="py-5 bg-light-pink">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <h2 class="display-5 room-title mb-2">Superior double room</h2>

                                <p class="small fw-bold mb-4">
                                    &nbsp;Max 2&nbsp; | &nbsp;From NOK 1,650
                                </p>

                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        <p class="mb-2 small">Twin bed</p>
                                        <p class="mb-2 small">Wifi available</p>
                                        <p class="mb-2 small">Hairdryer</p>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="mb-2 small">TV</p>
                                        <p class="mb-2 small">Bathroom with a shower</p>
                                        <p class="mb-2 small">Non smoking</p>
                                    </div>
                                </div>
                ...
                <div class="py-5 bg-light-pink">
                    <div class="container">
                        <div class="row">
                            ...
                            <div className="col-md-1"></div>
                            <div class="col-md-4">
                                <h2 class="display-5 room-title mb-2">Superior triple room</h2>

                                <p class="small fw-bold mb-4">
                                    12-23 m2&nbsp; | &nbsp;Max 3&nbsp; | &nbsp;From NOK 1,650
                                </p>

                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        <p class="mb-2 small">Twin or double bed</p>
                                        <p class="mb-2 small">Seating area</p>
                                        <p class="mb-2 small">TV</p>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="mb-2 small">Sofa bed/bunk bed/single bed</p>
                                        <p class="mb-2 small">Bathroom with a shower</p>
                                        <p class="mb-2 small">Hairdryer</p>
                                    </div>
                                </div>
